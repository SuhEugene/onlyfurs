...
<template>
  <div class="flex flex-col gap-2 justify-center items-center h-30">
    ...
    <template v-else-if="error">
      ...
      <button class="text-[13px] leading-none rounded-sm bg-muted hover:bg-muted-hover cursor-pointer transition-colors duration-100 px-3 py-2 flex items-center justify-center gap-1" tabindex="-1" @click="() => $emit('retry')">
