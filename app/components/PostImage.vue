...
<template>
  <a role="button" href="javascript:void(0)" :class="cn('relative cursor-pointer group/post-image rounded-t-xl overflow-hidden', !cropped && 'rounded-b-xl', $props.class)" @click.prevent.stop="open">
